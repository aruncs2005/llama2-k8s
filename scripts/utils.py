...
def parse_args():
    ...
    parser.add_argument("--persistent_dir",type=str,default="/admin/arun/llama2")
    ...
    if args.access_token is None:
        raise ValueError("Need access token to use LLama v2 please provide")
    ...
    print(f"local rank - {args.local_rank} global_rank - {args.rank} world size - {args.world_size}")
